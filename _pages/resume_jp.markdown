...
フロントエンドエンジニアとして 13 年の経験を積んできた。WebGL / Three.js を中心とした 3D・インタラクティブ開発を主軸に、ドイツ・アメリカ・オランダ・日本の 7 社でウェブサイトの開発に携わってきた。WebGL デベロッパーの経験から、シェーダー・行列演算・アフィン変換といった線形代数も日常業務として扱ってきた。WebGL の理解を深めるため、自作の軽量フレームワーク dan-shari-gl を npm に公開している。直近の NOT A HOTEL では Claude Code や Figma MCP を中心にした AI 駆動の開発フローづくりに取り組んでいる。
